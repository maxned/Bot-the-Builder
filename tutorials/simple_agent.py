...
class SimpleAgent(base_agent.BaseAgent):
    ...
    def step(self, obs):
        ...
        # if we have supply available and we can build marines -> queue up a Marine
            ...
            # pretty sure this only gets called once, further Marines just sit in base         
        ...
        # do nothing if none of these conditions are met
