...
class QCartPoleSolver():
    def __init__(self, buckets=(1, 1, 6, 12), n_episodes=10000, n_win_ticks=195, min_alpha=0.1, min_epsilon=0.1, gamma=1.0, ada_divisor=25, max_env_steps=None, quiet=False, monitor=False):
